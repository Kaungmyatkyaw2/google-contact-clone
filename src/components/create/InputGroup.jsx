...
const InputGroup = ({name,type,children}) => {
  return (
    <div className='relative'>
    <input name={name} type={type} id={children} className={`block border-b focus:border-b-2  pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent border-1 border-gray-300 appearance-none dark:text-white focus:outline-none focus:ring-0 focus:border-blue-600 peer`} placeholder=" " />
